  ...
  return (
    ...
    >
      <path
        ...
        className='transition-colors duration-300 ease-in-out group-hover:fill-primary-soft-red'
      />
    </svg>
  );
}
...
export function BookmarkLogoIcon({
  isExpanded,
  color,
}: {
  isExpanded?: boolean;
      ...
      <g fill='none' fillRule='evenodd'>
        <path
          ...
          className={clsx(
            ...
            color === "white" ? "fill-white" : "fill-[#242A45]"
          )}
        />
        <g>
          <circle
